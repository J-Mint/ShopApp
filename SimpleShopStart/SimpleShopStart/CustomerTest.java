...
public class CustomerTest
{
    ...
    public void testCustomerBuys(){
        ...
        assertEquals(800, shop.getTotalIncome(), "The shop has sold 4 things at a cost of 200 each\n");
    }
    ...
    public void testCustomerBudget(){
        ...
        assertEquals(0, shop.getTotalIncome(), "The customer did not have budget to buy and so the shop should not have sold anything\n");
        ...
        assertEquals(200, shop.getTotalIncome(), "The customer purchased one item costing 200 from this shop\n");
        customer.buy(1);
        ...
        assertEquals(400, shop.getTotalIncome(), "The customer purchased a second item costing 200 from this shop\n");
        // test budget used up
        customer.buy(1);
        assertEquals(400, customer.getAmountSpent(), "The customer has spent their budget and can no longer buy anything\n");
        assertEquals(400, shop.getTotalIncome(), "The customer has spent their budget and should not have bought anything more from this shop\n");
    }
